...
Mox.defmock(Egregoros.MiniApps.Fetcher.Mock, for: Egregoros.MiniApps.Fetcher)
Mox.defmock(Egregoros.MiniApps.ImageSanitizer.Mock, for: Egregoros.MiniApps.ImageSanitizer)
